...
class TablesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create table" do
    assert_difference("Table.count") do
      post tables_url, params: { table: { capacity: @table.capacity, status: @table.status, table_id: @table.table_id } }
    end
  ...
  test "should update table" do
    patch table_url(@table), params: { table: { capacity: @table.capacity, status: @table.status, table_id: @table.table_id } }
